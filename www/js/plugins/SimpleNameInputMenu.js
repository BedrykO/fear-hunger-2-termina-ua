//-----------------------------------------------------------------------------
// Simple (Single Page) Name Input Window With Backspace
//----------------------------------------------------------------------------

/*:
@plugindesc	This plugin makes a super simple (single page) player name input with an actual on-screen menu backspace button
@author		pEcOsGhOsT
@help		No plugin commands required! Simply add it to your plugin library and turn ON

HOW TO EDIT AVAILABLE CHARACTERS ON INPUT MENU (Letters, Numbers, Symbols):
To change the term for 'BACK' (or any other character for that matter) Just
edit the actual SimpleNameInputMenu.js plugin file (located where you put it
in the js folder in your game project folder, just right-click this .js file
and open with notepad or similar software) and change it to whatever you want!
*Look for the big block of characters in /js/plugins/SimpleNameInputMenu.js

NOTE: Be sure keep your new letter, number, symbol, etc inside the quotes ' '
 */
